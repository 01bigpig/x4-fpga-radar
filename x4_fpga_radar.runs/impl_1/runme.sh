...
HD_PWD='C:/Users/17392/x4_fpga_radar/x4_fpga_radar.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log x4_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source x4_bd_wrapper.tcl -notrace
