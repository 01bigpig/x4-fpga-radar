...
HD_PWD='C:/Users/17392/x4_fpga_radar/x4_fpga_radar.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log x4_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source x4_bd_wrapper.tcl
