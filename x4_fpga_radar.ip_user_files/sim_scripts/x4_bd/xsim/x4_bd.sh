...
#
# Script generated by Vivado on Mon Feb 09 19:49:29 -0600 2026
...
#
# Usage        : x4_bd.sh
#                x4_bd.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                x4_bd.sh [-rerun]
#                x4_bd.sh [-reset_run]
#                x4_bd.sh [-clean]
#                x4_bd.sh [-reset_log]
...
# script info
echo -e "x4_bd.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./x4_bd.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_22 -L processing_system7_vip_v1_0_24 -L axi_bram_ctrl_v4_1_13 -L blk_mem_gen_v8_4_12 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_36 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot x4_bd xil_defaultlib.x4_bd xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim x4_bd -key {Behavioral:sim_1:Functional:x4_bd} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_aabe.protoinst" -protoinst "protoinst_files/x4_bd.protoinst" -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb x4_bd.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./x4_bd.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: x4_bd.sh [-help]\n\
Usage: x4_bd.sh [-step]\n\
Usage: x4_bd.sh [-lib_map_path]\n\
Usage: x4_bd.sh [-rerun]\n\
Usage: x4_bd.sh [-reset_run]\n\
Usage: x4_bd.sh [-clean]\n\
Usage: x4_bd.sh [-reset_log]\n\
Usage: x4_bd.sh [-keep_index]\n\
Usage: x4_bd.sh [-noclean_files]\n\n\
