...
//Date        : Mon Feb  9 19:49:16 2026
//Host        : LAPTOP-MRHU30BR running 64-bit major release  (build 9200)
//Command     : generate_target x4_bd.bd
//Design      : x4_bd
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "x4_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=x4_bd,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,synth_mode=None}" *) (* HW_HANDOFF = "x4_bd.hwdef" *) 
module x4_bd
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [11:0]radar_ctrl_top_0_bram_addr;
  wire radar_ctrl_top_0_bram_clkb;
  wire [31:0]radar_ctrl_top_0_bram_dinb;
  wire radar_ctrl_top_0_bram_en;
  wire radar_ctrl_top_0_bram_rstb;
  wire [3:0]radar_ctrl_top_0_bram_we;
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40000000 32 > x4_bd blk_mem_gen_0" *) 
  (* KEEP_HIERARCHY = "YES" *) 
  x4_bd_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  x4_bd_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,radar_ctrl_top_0_bram_addr}),
        .clka(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .clkb(radar_ctrl_top_0_bram_clkb),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(radar_ctrl_top_0_bram_dinb),
        .douta(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .doutb(blk_mem_gen_0_doutb),
        .ena(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .enb(radar_ctrl_top_0_bram_en),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(radar_ctrl_top_0_bram_rstb),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web(radar_ctrl_top_0_bram_we));
  (* BMM_INFO_PROCESSOR = "arm > x4_bd axi_bram_ctrl_0" *) 
  (* KEEP_HIERARCHY = "YES" *) 
  x4_bd_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
  ...
  x4_bd_radar_ctrl_top_0_0 radar_ctrl_top_0
       (.bram_addrb(radar_ctrl_top_0_bram_addr),
        .bram_clkb(radar_ctrl_top_0_bram_clkb),
        .bram_dinb(radar_ctrl_top_0_bram_dinb),
        .bram_doutb(blk_mem_gen_0_doutb),
        .bram_enb(radar_ctrl_top_0_bram_en),
        .bram_rstb(radar_ctrl_top_0_bram_rstb),
        .bram_web(radar_ctrl_top_0_bram_we),
        .clk_100m(processing_system7_0_FCLK_CLK0),
        .spi_cs_n(spi_cs),
        .spi_miso(spi_miso),
        .spi_mosi(spi_mosi),
        .spi_sck(spi_sck));
  x4_bd_rst_ps7_0_100M_0 rst_ps7_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
